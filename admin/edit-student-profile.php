...
$ret=mysqli_query($con,"update students set studentName='$studentname',studentPhoto='$photo' where email='$email'");
if($ret)
{
...
$sql=mysqli_query($con,"select * from students where email='$email'");
$cnt=1;
...
<div class="form-group">
  ...
  <div class="form-group">
    <label for="Pincode">Pincode  </label>
    <input type="text" class="form-control" id="email" name="email" readonly value="<?php echo htmlentities($row['email']);?>" required />
  </div> 
