...
$sql=mysqli_query($con,"SELECT password FROM  students where password='$currentpass' && email='$email'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"update students set password='$newpass', updationDate='$currentTime' where email='$email'");
...
<font color="black" align="center"><?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?></font>
