...
$ret=mysqli_query($con,"update students set studentName='$studentname',studentPhoto='$photo'  where email='".$_SESSION['login']."'");
if($ret)
{
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form name="dept" method="post" enctype="multipart/form-data">
                            <?php
                            $sql = mysqli_query($con, "select * from students where email='" . $_SESSION['login'] . "'");
